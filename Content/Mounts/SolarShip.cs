...
{
    public class SolarShip : ModMount
    {
        // override public string Texture => $"Terraria/Images/Extras_{ExtrasID.PirateShipMount}";
        ...
        public override void SetStaticDefaults()
        {
            ...
            mountData.buff = ModContent.BuffType<SolarShipBuff>();
            ...
            if (Main.netMode != NetmodeID.Server)
            {
                ...
                // 用自身的贴图
                // mountData.frontTexture = Mod.Assets.Request<Texture2D>($"Content/Mounts/SolarShip_Front", AssetRequestMode.AsyncLoad);
