...
namespace WuDao.Common.Players
{
    ...
    public class MimickerSystem : ModSystem
    {
        ...
        public static readonly UnlockDef[] UnlockTable = new UnlockDef[]
        {
            ...
            new UnlockDef(NPCID.IchorSticker, ProjectileID.GoldenShowerFriendly, 10, "黄金雨"),
            // 腐化者（喷吐咒火弹） -> 诅咒焰
            new UnlockDef(NPCID.Corruptor, ProjectileID.CursedFlameFriendly, 10, "诅咒焰"),
            // 地牢死灵施法者 -> 暗影光束
            new UnlockDef(NPCID.Necromancer, ProjectileID.ShadowBeamFriendly, 8, "暗影光束"),
            // 地牢幻魂 -> 幻魂弹（幽灵怨魂）
            new UnlockDef(NPCID.DungeonSpirit, ProjectileID.SpectreWrath, 12, "幽魂之怒"),
            // 地下寒霜法师 -> 水晶风暴
            new UnlockDef(NPCID.IceElemental, ProjectileID.CrystalStorm, 8, "水晶风暴"),
        };
    ...
    public class MimickerPlayer : ModPlayer
    {
        ...
        {
            // 基础池 + 解锁池
            foreach (var t in MimickerSystem.BasePool)
                yield return t;
    ...
    public class MimickerGlobalNPC : GlobalNPC
    {
        ...
        {
            if (!lastHitByMimicker || lastHitterPlayer < 0)
                return;
